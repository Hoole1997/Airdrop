...
class ChainOperaConverter : JSONConvert(code = "code", message = "message", success = "SUCCESS") {
    ...
    override fun <R> String.parseBody(succeed: Type): R? {
        ...
        val resultJson = jsonObject.opt("data")
        ...
        return when (resultJson) {
            is Boolean -> {
                ...
                // 其他类型，尝试解析
                GsonUtils.fromJson(jsonObject.optString("data"), succeed)
            }
        }
    }
